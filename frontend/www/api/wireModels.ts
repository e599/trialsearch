...
const typeMap: any = {
  ...
  DetailAgeRange: o([{ json: "age_range", js: "age_range", typ: "" }], "any"),
  DetailCondition: o(
    [{ json: "condition", js: "condition", typ: "" }, { json: "new_id", js: "new_id", typ: "" }],
    "any",
  ),
  DetailContact: o(
    [
  ...
  DetailSex: o([{ json: "gender", js: "gender", typ: "" }, { json: "new_id", js: "new_id", typ: "" }], "any"),
  DetailHealthyVolunteers: o(
    [{ json: "healthy_volunteers", js: "healthy_volunteers", typ: "" }, { json: "new_id", js: "new_id", typ: "" }],
    "any",
  ),
  ...
  DetailMeshTerm: o(
    [{ json: "mesh_term", js: "mesh_term", typ: "" }, { json: "new_id", js: "new_id", typ: "" }],
    "any",
  ),
  DetailAgency: o([{ json: "agency", js: "agency", typ: "" }, { json: "new_id", js: "new_id", typ: "" }], "any"),
  ErrorResponse: o(
    [
